...
const V6_PATH_DOCS = {
    ...
    'MobileAction|actionList': {
        description: '**核心**：操作项 `[{ value, icon?, color?, tag? }]`；中继生成 Sheet children `jh-sheet-menu-grid`。',
    },
    ...
    'Sheet|actionList': {
        description: '**标题栏**按钮（与 FormSheet/Drawer 一致）。图标网格请用 MobileAction → jh-sheet-menu-grid。',
    },
