...
exports.activateJsonDocCodeLens = exports.JsonDocCodeLensProvider = void 0;
    ...
    showPropertyDoc(propertyName, docInfo) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                // 创建并显示 WebviewPanel
                const panel = vscode.window.createWebviewPanel('propertyDoc', `${propertyName} 文档`, vscode.ViewColumn.Two, // 在右侧显示
                {
                    enableScripts: true,
...
function activateJsonDocCodeLens(context) {
    ...
    // 注册代码镶边提供者
    const codeLensProvider = vscode.languages.registerCodeLensProvider({ language: 'javascript', pattern: '**/app/view/init-json/**/*.js' }, provider);
    // 注册命令
