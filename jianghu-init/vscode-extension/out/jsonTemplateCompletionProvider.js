...
exports.activateJsonTemplateCompletion = exports.JsonTemplateCompletionProvider = void 0;
 ...
 * JSON模板代码补全提供者
 */
class JsonTemplateCompletionProvider {
...
exports.JsonTemplateCompletionProvider = JsonTemplateCompletionProvider;
/**
 * 激活JSON模板代码补全
 * @param context 扩展上下文
 */
function activateJsonTemplateCompletion(context) {
    // 注册代码补全提供者
    const completionProvider = vscode.languages.registerCompletionItemProvider({ language: 'javascript', pattern: '**/{page-template-json,init-json}/**/*.js' }, new JsonTemplateCompletionProvider(), 
    // 触发字符
    ':', '{', '[');
    context.subscriptions.push(completionProvider);
}
exports.activateJsonTemplateCompletion = activateJsonTemplateCompletion;
//# sourceMappingURL=jsonTemplateCompletionProvider.js.map