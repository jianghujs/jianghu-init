...
module.exports = class InitPage2Table extends CommandBase {
  ...
  async generateCrud() {
    ...
    if (await this.renderVue('3table/a_crud.html', _.camelCase(tableA) + 'Management', { tableA, nameA, tableB, nameB, table: tableA, middlePageId: baMiddlePageId, primaryFieldA, primaryFieldB, title: nameA })) {
      this.success(`生成 ${tableA} 的 vue 文件完成`);
    }
    if (await this.renderVue('3table/2table_b.html', baMiddlePageId, { tableB, nameB, tableA, nameA, table: tableB, primaryFieldA, primaryFieldB, title: baMiddlePageId, tableMiddle: tableB, tableView: tableB })) {
