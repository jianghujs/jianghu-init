...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COMMENT='数据历史表';
...
CREATE TABLE `_resource` (
  ...
  `operationAt` varchar(255) DEFAULT NULL COMMENT '操作时间; E.g: 2021-05-28T10:24:54+08:00 ',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=379 DEFAULT CHARSET=utf8mb4 COMMENT='请求资源表; 软删除未启用; resourceId=`${appId}.${pageId}.${actionId}`';
...
INSERT INTO `_resource` (`id`, `accessControlTable`, `resourceHook`, `pageId`, `actionId`, `desc`, `resourceType`, `appDataSchema`, `resourceData`, `requestDemo`, `responseDemo`, `operation`, `operationByUserId`, `operationByUser`, `operationAt`) VALUES (374, NULL, NULL, 'constantUiManagement', 'selectItemList', '✅ui配置-查询列表', 'sql', '{}', '{\"table\": \"web_constant_ui\", \"operation\": \"select\"}', '', '', 'insert', NULL, NULL, NULL);
INSERT INTO `_resource` (`id`, `accessControlTable`, `resourceHook`, `pageId`, `actionId`, `desc`, `resourceType`, `appDataSchema`, `resourceData`, `requestDemo`, `responseDemo`, `operation`, `operationByUserId`, `operationByUser`, `operationAt`) VALUES (375, NULL, NULL, 'constantUiManagement', 'insertItem', '✅ui配置-添加成员', 'sql', '{}', '{\"table\": \"web_constant_ui\", \"operation\": \"insert\"}', '', '', 'insert', NULL, NULL, NULL);
INSERT INTO `_resource` (`id`, `accessControlTable`, `resourceHook`, `pageId`, `actionId`, `desc`, `resourceType`, `appDataSchema`, `resourceData`, `requestDemo`, `responseDemo`, `operation`, `operationByUserId`, `operationByUser`, `operationAt`) VALUES (376, NULL, NULL, 'constantUiManagement', 'updateItem', '✅ui配置-更新成员', 'sql', '{}', '{\"table\": \"web_constant_ui\", \"operation\": \"jhUpdate\"}', '', '', 'insert', NULL, NULL, NULL);
INSERT INTO `_resource` (`id`, `accessControlTable`, `resourceHook`, `pageId`, `actionId`, `desc`, `resourceType`, `appDataSchema`, `resourceData`, `requestDemo`, `responseDemo`, `operation`, `operationByUserId`, `operationByUser`, `operationAt`) VALUES (377, NULL, NULL, 'constantUiManagement', 'deleteItem', '✅ui配置-删除信息', 'sql', '{}', '{\"table\": \"web_constant_ui\", \"operation\": \"jhDelete\"}', '', '', 'insert', NULL, NULL, NULL);
...
) ENGINE=InnoDB AUTO_INCREMENT=37 DEFAULT CHARSET=utf8mb4 COMMENT='常量表;';
...
INSERT INTO `web_constant_ui` (`id`, `constantKey`, `constantType`, `pageId`, `desc`, `en`, `zh`, `kr`, `yueyu`, `operation`, `operationByUserId`, `operationByUser`, `operationAt`) VALUES (36, 'header333', 'html', 'header', '', NULL, 'test1111', NULL, NULL, 'jhUpdate', 'admin', '系统管理员', '2023-02-04T21:30:43+08:00');
COMMIT;
