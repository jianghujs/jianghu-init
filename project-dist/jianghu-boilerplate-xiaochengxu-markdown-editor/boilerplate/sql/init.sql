/*
 ...
 Source Schema         : jianghujs_xiaochengxu_markdown_editor
...
CREATE ALGORITHM = UNDEFINED SQL SECURITY DEFINER VIEW `view01_category` AS select `jianghujs_xiaochengxu_markdown_editor`.`category`.`id` AS `id`,ifnull(`article_category`.`articleCount`,0) AS `articleCount`,`jianghujs_xiaochengxu_markdown_editor`.`category`.`categoryId` AS `categoryId`,`jianghujs_xiaochengxu_markdown_editor`.`category`.`categoryName` AS `categoryName`,`jianghujs_xiaochengxu_markdown_editor`.`category`.`categoryArticleIgnoreTiltle` AS `categoryArticleIgnoreTiltle`,`jianghujs_xiaochengxu_markdown_editor`.`category`.`categoryGroup` AS `categoryGroup`,`jianghujs_xiaochengxu_markdown_editor`.`category`.`categoryGroupSort` AS `categoryGroupSort`,concat('<',`jianghujs_xiaochengxu_markdown_editor`.`category`.`categoryGroup`,`jianghujs_xiaochengxu_markdown_editor`.`category`.`categoryGroupSort`,'>') AS `categoryGroupConcat`,`jianghujs_xiaochengxu_markdown_editor`.`category`.`categoryIntro` AS `categoryIntro`,`jianghujs_xiaochengxu_markdown_editor`.`category`.`categoryPublishStatus` AS `categoryPublishStatus`,`jianghujs_xiaochengxu_markdown_editor`.`category`.`categoryCreateTime` AS `categoryCreateTime`,`jianghujs_xiaochengxu_markdown_editor`.`category`.`categoryCreateUserId` AS `categoryCreateUserId`,`jianghujs_xiaochengxu_markdown_editor`.`category`.`categoryCreateUsername` AS `categoryCreateUsername`,`jianghujs_xiaochengxu_markdown_editor`.`category`.`categoryUpdateTime` AS `categoryUpdateTime`,`jianghujs_xiaochengxu_markdown_editor`.`category`.`categoryUpdateUserId` AS `categoryUpdateUserId`,`jianghujs_xiaochengxu_markdown_editor`.`category`.`categoryUpdateUsername` AS `categoryUpdateUsername`,`jianghujs_xiaochengxu_markdown_editor`.`category`.`operation` AS `operation`,`jianghujs_xiaochengxu_markdown_editor`.`category`.`operationByUserId` AS `operationByUserId`,`jianghujs_xiaochengxu_markdown_editor`.`category`.`operationByUser` AS `operationByUser`,`jianghujs_xiaochengxu_markdown_editor`.`category`.`operationAt` AS `operationAt` from (`jianghujs_xiaochengxu_markdown_editor`.`category` left join (select `jianghujs_xiaochengxu_markdown_editor`.`article`.`categoryId` AS `categoryId`,count(`jianghujs_xiaochengxu_markdown_editor`.`article`.`categoryId`) AS `articleCount` from `jianghujs_xiaochengxu_markdown_editor`.`article` group by `jianghujs_xiaochengxu_markdown_editor`.`article`.`categoryId`) `article_category` on((`jianghujs_xiaochengxu_markdown_editor`.`category`.`categoryId` = `article_category`.`categoryId`)));
