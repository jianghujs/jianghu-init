/*
 ...
 Source Schema         : {{dbPrefix}}data_repository
...
-- ----------------------------
BEGIN;
INSERT INTO `_table_sync_config` (`id`, `sourceDatabase`, `sourceTable`, `syncTimeSlot`, `syncDesc`, `lastSyncTime`, `operation`, `operationByUserId`, `operationByUser`, `operationAt`) VALUES (202, '{{dbPrefix}}user_app_management', '_user_app', '5', '正常', '2023-03-01T20:48:36+08:00', 'update', 'admin', '系统管理员', '2023-03-01T20:48:44+08:00');
INSERT INTO `_table_sync_config` (`id`, `sourceDatabase`, `sourceTable`, `syncTimeSlot`, `syncDesc`, `lastSyncTime`, `operation`, `operationByUserId`, `operationByUser`, `operationAt`) VALUES (203, '{{dbPrefix}}user_app_management', '_app', '5', '正常', '2023-03-01T20:48:36+08:00', 'update', 'admin', '系统管理员', '2023-03-01T20:48:44+08:00');
INSERT INTO `_table_sync_config` (`id`, `sourceDatabase`, `sourceTable`, `syncTimeSlot`, `syncDesc`, `lastSyncTime`, `operation`, `operationByUserId`, `operationByUser`, `operationAt`) VALUES (204, '{{dbPrefix}}user_app_management', '_user', '5', '正常', '2023-03-01T20:48:36+08:00', 'update', 'admin', '系统管理员', '2023-03-01T20:48:44+08:00');
INSERT INTO `_table_sync_config` (`id`, `sourceDatabase`, `sourceTable`, `syncTimeSlot`, `syncDesc`, `lastSyncTime`, `operation`, `operationByUserId`, `operationByUser`, `operationAt`) VALUES (205, '{{dbPrefix}}user_app_management', '_test_case', '5', '正常', '2023-03-01T20:48:36+08:00', 'update', 'admin', '系统管理员', '2023-03-01T20:48:44+08:00');
...
-- ----------------------------
BEGIN;
INSERT INTO `_table_sync_log` (`id`, `sourceDatabase`, `sourceTable`, `syncAction`, `syncDesc`, `syncTime`, `operation`, `operationByUserId`, `operationByUser`, `operationAt`) VALUES (1, '{{dbPrefix}}user_app_management', '_test_case', '仓库表覆盖', '【表覆盖】结构不一致; 触发覆盖仓库表逻辑;', '2022-12-09T13:47:23+08:00', 'insert', NULL, NULL, '2022-12-09T13:47:23+08:00');
INSERT INTO `_table_sync_log` (`id`, `sourceDatabase`, `sourceTable`, `syncAction`, `syncDesc`, `syncTime`, `operation`, `operationByUserId`, `operationByUser`, `operationAt`) VALUES (2, '{{dbPrefix}}user_app_management', '_test_case', '触发器覆盖', 'insert 触发器覆盖', '2022-12-09T13:47:23+08:00', 'insert', NULL, NULL, '2022-12-09T13:47:23+08:00');
INSERT INTO `_table_sync_log` (`id`, `sourceDatabase`, `sourceTable`, `syncAction`, `syncDesc`, `syncTime`, `operation`, `operationByUserId`, `operationByUser`, `operationAt`) VALUES (3, '{{dbPrefix}}user_app_management', '_test_case', '触发器覆盖', 'insert 触发器覆盖', '2022-12-09T13:47:24+08:00', 'insert', NULL, NULL, '2022-12-09T13:47:24+08:00');
INSERT INTO `_table_sync_log` (`id`, `sourceDatabase`, `sourceTable`, `syncAction`, `syncDesc`, `syncTime`, `operation`, `operationByUserId`, `operationByUser`, `operationAt`) VALUES (4, '{{dbPrefix}}user_app_management', '_test_case', '触发器覆盖', 'delete 触发器覆盖', '2022-12-09T13:47:24+08:00', 'insert', NULL, NULL, '2022-12-09T13:47:24+08:00');
...
-- ----------------------------
-- Table structure for {{dbPrefix}}user_app_management___app
-- ----------------------------
...
-- ----------------------------
-- Records of {{dbPrefix}}user_app_management___app
-- ----------------------------
BEGIN;
...
INSERT INTO `{{dbPrefix}}user_app_management___app` (`id`, `appId`, `appGroup`, `appName`, `appDesc`, `appUrl`, `appMenu`, `appType`, `operation`, `operationByUserId`, `operationByUser`, `operationAt`, `sort`) VALUES (22, '090909', NULL, '090909', NULL, NULL, NULL, 'internal', 'jhInsert', 'admin', '系统管理员', '2022-09-09T16:26:10+08:00', NULL);
COMMIT;

-- ----------------------------
-- Table structure for {{dbPrefix}}user_app_management___test_case
-- ----------------------------
DROP TABLE IF EXISTS `{{dbPrefix}}user_app_management___test_case`;
CREATE TABLE `{{dbPrefix}}user_app_management___test_case` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `pageId` varchar(255) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '页面Id',
  `testId` varchar(255) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '测试用例Id; 10000 ++',
  `testName` varchar(255) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '测试用例名',
...
-- ----------------------------
-- Records of {{dbPrefix}}user_app_management___test_case
-- ----------------------------
BEGIN;
INSERT INTO `{{dbPrefix}}user_app_management___test_case` (`id`, `pageId`, `testId`, `testName`, `uiActionIdList`, `testOpeartion`, `expectedResult`, `operation`, `operationByUserId`, `operationByUser`, `operationAt`) VALUES (197, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
COMMIT;

-- ----------------------------
-- Table structure for {{dbPrefix}}user_app_management___user
-- ----------------------------
...
-- ----------------------------
-- Records of {{dbPrefix}}user_app_management___user
-- ----------------------------
BEGIN;
...
-- ----------------------------
-- Table structure for {{dbPrefix}}user_app_management___user_app
-- ----------------------------
...
-- ----------------------------
-- Records of {{dbPrefix}}user_app_management___user_app
-- ----------------------------
BEGIN;
...
INSERT INTO `{{dbPrefix}}user_app_management___user_app` (`id`, `userId`, `appId`, `operation`, `operationByUserId`, `operationByUser`, `operationAt`) VALUES (141, 'admin', 'null', 'jhInsert', 'admin', '系统管理员', '2022-09-09T16:25:35+08:00');
INSERT INTO `{{dbPrefix}}user_app_management___user_app` (`id`, `userId`, `appId`, `operation`, `operationByUserId`, `operationByUser`, `operationAt`) VALUES (148, 'admin', '090909', 'jhInsert', 'admin', '系统管理员', '2022-09-09T16:26:27+08:00');
INSERT INTO `{{dbPrefix}}user_app_management___user_app` (`id`, `userId`, `appId`, `operation`, `operationByUserId`, `operationByUser`, `operationAt`) VALUES (152, 'U224R', '090909', 'jhInsert', 'admin', '系统管理员', '2022-09-09T16:27:03+08:00');
COMMIT;
