...
select
  `jianghujs_hrm_data_repository`.`jianghujs_hrm_user_app_management___user`.`id` AS `id`,
  `jianghujs_hrm_data_repository`.`jianghujs_hrm_user_app_management___user`.`idSequence` AS `idSequence`,
  `jianghujs_hrm_data_repository`.`jianghujs_hrm_user_app_management___user`.`userId` AS `userId`,
  `jianghujs_hrm_data_repository`.`jianghujs_hrm_user_app_management___user`.`username` AS `username`,
  `jianghujs_hrm_data_repository`.`jianghujs_hrm_user_app_management___user`.`clearTextPassword` AS `clearTextPassword`,
  `jianghujs_hrm_data_repository`.`jianghujs_hrm_user_app_management___user`.`password` AS `password`,
  `jianghujs_hrm_data_repository`.`jianghujs_hrm_user_app_management___user`.`md5Salt` AS `md5Salt`,
  `jianghujs_hrm_data_repository`.`jianghujs_hrm_user_app_management___user`.`userStatus` AS `userStatus`,
  `jianghujs_hrm_data_repository`.`jianghujs_hrm_user_app_management___user`.`userType` AS `userType`,
  `jianghujs_hrm_data_repository`.`jianghujs_hrm_user_app_management___user`.`userConfig` AS `userConfig`,
  `jianghujs_hrm_data_repository`.`jianghujs_hrm_user_app_management___user`.`operation` AS `operation`,
  `jianghujs_hrm_data_repository`.`jianghujs_hrm_user_app_management___user`.`operationByUserId` AS `operationByUserId`,
  `jianghujs_hrm_data_repository`.`jianghujs_hrm_user_app_management___user`.`operationByUser` AS `operationByUser`,
  `jianghujs_hrm_data_repository`.`jianghujs_hrm_user_app_management___user`.`operationAt` AS `operationAt`
from
  (
  `jianghujs_hrm_data_repository`.`jianghujs_hrm_user_app_management___user`
  join `jianghujs_hrm_data_repository`.`jianghujs_hrm_user_app_management___user_app` on(
    (
    `jianghujs_hrm_data_repository`.`jianghujs_hrm_user_app_management___user`.`userId` = `jianghujs_hrm_data_repository`.`jianghujs_hrm_user_app_management___user_app`.`userId`
    )
  )
  )
where
  (
  `jianghujs_hrm_data_repository`.`jianghujs_hrm_user_app_management___user_app`.`appId` = 'employee_client'
  );
...
from
  (
  (
    `jianghujs_hrm_data_repository`.`jianghujs_hrm_user_app_management___user_app` `_user_app`
    join `jianghujs_hrm_data_repository`.`jianghujs_hrm_user_app_management___user` `_user` on((`_user_app`.`userId` = `_user`.`userId`))
  )
  join `jianghujs_hrm_data_repository`.`jianghujs_hrm_user_app_management___app` `_app` on((`_user_app`.`appId` = `_app`.`appId`))
  );
